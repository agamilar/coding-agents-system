...
**✅ Рекомендуется:**
- Использовать **английский язык** для описания задач
- Чёткое описание требований
- Примеры входных/выходных данных
- Указание необходимых тестов
...
Body:
Create file fibonacci.py with:
- Function fibonacci(n) that returns nth Fibonacci number
...
**❌ Избегайте:**
- Расплывчатых описаний на русском: "сделай какую-нибудь функцию"
- Слишком сложных задач в одном Issue
